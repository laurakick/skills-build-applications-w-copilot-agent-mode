              ...
              <div className="text-center mt-5">
                <div className="card shadow mx-auto p-4" style={{maxWidth: '500px'}}>
                  <div className="card-body">
                    <h1 className="card-title display-5 fw-bold mb-3">Welcome to OctoFit Tracker</h1>
                    <p className="card-text lead">Track your fitness, join teams, and compete with friends at Mergington High School!</p>
